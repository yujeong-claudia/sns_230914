...
<script>
	$(document).ready(function() {
		...
		$(".more-btn").on('click', function(e) {
			...
			let postId = $(this).data("post-id"); // getting -> 파라미터가 1개
			//alert(postId);
			
			// 1개로 존재하는 모달에 재활용을 위해 data-post-id를 심는다.(...) 버튼을 누를 때마다
			$("#modal").data("post-id", postId); // setting  -> 파라미터가 2개
		});
